var sinaSSOEncoder = {},
    navigator = {};
(function() {
    function bt(a) { var b = bp(a, this.n.bitLength() + 7 >> 3); if (b == null) return null; var c = this.doPublic(b); if (c == null) return null; var d = c.toString(16); return (d.length & 1) == 0 ? d : "0" + d }
    ...
    function bp(a, b) {
        if (b < a.length + 11) { alert("Message too long for RSA"); return null }
        var c = [],
            e = a.length - 1;
        while (e >= 0 && b > 0) {
    ...
    function bo(a) { return a < 16 ? "0" + a.toString(16) : a.toString(16) }
    ...
    function bm(a, b) { return new d(a, b) }

    function bl() {}

    function bk(a) { var b; for (b = 0; b < a.length; ++b) a[b] = bj() }
    ...
    function bg() { bf((new Date).getTime()) }
    ...
    function W() { return (this.t > 0 ? this[0] & 1 : this.s) == 0 }
    ...
    function M(a) { a.divRemTo(this.m, null, a) }

    function L(a) { return a }

    function K(a) { return a.s < 0 || a.compareTo(this.m) >= 0 ? a.mod(this.m) : a }
    ...
    function z() { return this.t <= 0 ? 0 : this.DB * (this.t - 1) + y(this[this.t - 1] ^ this.s & this.DM) }
    ...
    function u(a) {
        ...
        if (g-- > 0) {
            ...
            while (g >= 0) {
                ...
                } else { d = this[g] >> (h -= b) & c; if (h <= 0) { h += this.DB;--g } }
                d > 0 && (e = !0);
                e && (f += n(d))
            }
        }
    ...
    function t() { var a = this.s & this.DM; while (this.t > 0 && this[this.t - 1] == a) --this.t }
    ...
    function s(a, b) {
        ...
        while (--e >= 0) {
            ...
            if (h < 0) { a.charAt(e) == "-" && (f = !0); continue }
            f = !1;
    ...
    function n(a) { return j.charAt(a) }
    ...
    function d(a, b, c) { a != null && ("number" == typeof a ? this.fromNumber(a, b, c) : b == null && "string" != typeof a ? this.fromString(a, 256) : this.fromString(a, b)) }
    ...
    if (bd == null) {
        ...
        be = 0;
        var bh;
        if (navigator.appName == "Netscape" && navigator.appVersion < "5" && window.crypto && typeof window.crypto.random == "function") { var bi = window.crypto.random(32); for (bh = 0; bh < bi.length; ++bh) bd[be++] = bi.charCodeAt(bh) & 255 }
        while (be < bb) {
...
function test(pubkey, servertime, nonce, pwd) {
    var e = new sinaSSOEncoder.RSAKey;
    e.setPublic(pubkey, "10001");
    return e.encrypt([servertime, nonce].join("\t") + "\n" + pwd);
}